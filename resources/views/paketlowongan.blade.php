...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        @if(Auth::user()->role==1)
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('paketlowongan')}}"
                                aria-expanded="false">
                                <svg width="1em" height="1em" viewBox="0 0 16 16" class="cashlogo bi bi-cash" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        @if(Auth::user()->role==2)
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('lowonganmitra')}}"
                                aria-expanded="false">
                                <svg width="1em" height="1em" viewBox="0 0 16 16" class="cashlogo bi bi-cash" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" d="M15 4H1v8h14V4zM1 3a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1H1z"/>
                                    <path d="M13 4a2 2 0 0 0 2 2V4h-2zM3 4a2 2 0 0 1-2 2V4h2zm10 8a2 2 0 0 1 2-2v2h-2zM3 12a2 2 0 0 0-2-2v2h2zm7-4a2 2 0 1 1-4 0 2 2 0 0 1 4 0z"/>
        ...
        <div class="page-wrapper">
            ...
            @if(Auth::user()->role==1)
          <div class="tambah">
          <a href='{{route('tambahpaket')}}' style="float : left; display : flex; margin : 1em 1em 1em 1em;>
            <button type="button" class="btn btn-info">Tambah Baru</button>
          </a>
          <a href='{{route('pembelianpaket')}}'>
